                ...
                <div class="panel-boy text-left">
                    ...
                    <h6>Trạng thái đơn hàng: <?php if($order['status'] == 0){?>
                        ...
                        <form action="" method="post">
                            <label for=""></label>
                            <select name="status" id="" class="form-control" style="width:250px; margin-bottom:10px;">
                                <option value="0">Chưa xác nhận</option>
                                <option value="1">Đã xác nhận</option>
                                <option value="2">Đang giao hàng</option>
                                <option value="3">Giao hàng thành công</option>
                                <option value="4">Giao hàng không thành công</option>
                            </select>
                        ...
                        <tbody>
                            <?php foreach ($product as $key => $value):?>
                                <tr>
                                    ...
                                    <td><img src="images/<?php echo $value['image']?>" alt="" width="100px"></td>
